...
\ifabstract\else
 ...
 \include{Chapter/2.Siwecal}
 \include{Chapter/3.Beamtest}
 \include{Chapter/4.Deeplearning}
 \include{Chapter/5.Flavortagging}
...
\ifabstract\else
 \appendix
 \include{Chapter/Appendix/7.AppendixA}
\fi

%----------------------------------------------------------------------------------------------------
%----- 謝辞
\ifabstract\else
 \include{Chapter/8.Acknowledgement}
\fi
