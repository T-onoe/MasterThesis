...
本研究では、MCイベントジェネレーターであるwhizardによる事象生成を行い、ILD検出器のフルシミュレーションを使用したデータを用いてフレーバー識別を行った。シミュレーションデータについての詳細を表\ref{inputs}に示す。
\begin{table}[Hhtb]
 \begin{center}
 \label{inputs}
 ...
 検出器モデル & ILD\_l5\_250$\mathrm{GeV}$\_v02-02\\
