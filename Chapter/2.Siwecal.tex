...
\begin{minipage}[h]{.45\linewidth}
 ...
 \includegraphics[keepaspectratio, scale=0.8]
 	{Figure/Siwecal/si_sensor.png}
 		\caption{シリコンパッドセンサー\cite{sipad}}
 		\label{sensor}
	\end{center}
\end{minipage}
\end{figure}
